...
Use this project wizard to quickly create your own GitHub project. [**`Login`**](https://github.com/login) to use the following projects wizard buttons ⤵
...
_Heavy artillery. Use this template to create native utilities._
...
<details>
  ...
  _Deprecated. See [JetBrains/compose-jb](https://github.com/JetBrains/compose-jb)_  
